...
class Linter {
   ...
   */
  init() {
    const eslintHelp = generators.genEslintHelp(this.eslintCmd)
    const eslintFlags = generators.genEslintFlags(eslintHelp)
    const [help, options, shortcuts, flags] = generators.genEslintShortcutsAndOpts(eslintHelp, eslintFlags)
    this.help = help
    this.flags = flags
